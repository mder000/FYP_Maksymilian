...
# Custom metric for regression accuracy within a tolerance.
# With threshold=2, this metric returns the fraction of predictions that are within 2 redshift units.
        ...
        if not match_row.empty:
            ...
            if z_spec > 0:
                ...
                with fits.open(fits_path) as spec:
                    data = spec[1].data
                    wavelength = data['wavelength'] * 1e4  # Convert to Angstrom
                    flux = data['flux']
